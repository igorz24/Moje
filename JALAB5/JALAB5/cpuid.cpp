...
//{
//
//	cout << "To odpalil Igor Zuber" << endl << endl;
//	char CPUString[0x20];
...
int main() {
	if (1)
		cout << "SSE2 Jest" << endl;
	else cout << "SSE2 Nie ma" << endl;
	cout << radtodegnmeacpp(3.1415926, 1)/100 << endl;
	system("pause");
}
